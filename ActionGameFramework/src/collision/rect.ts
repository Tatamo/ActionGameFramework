module Game {
    export class Rect extends AbstractShape {
        ...
        get centerx(): number { return this.x + this.width; }
        set centerx(v: number) { this.x = v - this.width; }
        get centery(): number { return this.y + this.height; }
        set centery(v: number) { this.y = v - this.height; }
